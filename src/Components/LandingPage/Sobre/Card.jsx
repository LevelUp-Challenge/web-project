        ...
        <>
            <DivParticipantes>
                <div className="flex">
                    ...
                    <div className="infos">
                        <h2>{props.nome}</h2>
                        <p><b>GitHub: </b><a href={props.linkGitHub} target="_blank" rel="noreferrer" >{props.nomeGitHub}</a></p>
                        <p><b>Linkedin: </b><a href={props.linkLinkedin} target="_blank" rel="noreferrer" >{props.nomeLinkedin}</a></p>
                    </div>
                </div>
            </DivParticipantes>
        </>
